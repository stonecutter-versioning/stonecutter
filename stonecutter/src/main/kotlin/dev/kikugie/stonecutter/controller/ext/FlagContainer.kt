...
public sealed interface MutableFlagContainer : FlagContainer {
    ...
    public companion object {
        internal val FlagContainer.container: StonecutterFlags
            get() = takeAs<Impl>().flags

        internal operator fun invoke(flags: StonecutterFlags): MutableFlagContainer = Impl(flags)
    }
}
